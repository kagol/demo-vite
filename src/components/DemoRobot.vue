<template>
  <tiny-container :show="false" v-model:fullscreen="fullscreen" class="tiny-container">
    <template #operations>
  ...
  <div v-show="true" class="chat-container">
...
import { IconAi, IconFullScreen, IconUser } from '@opentiny/tiny-robot-svgs'
