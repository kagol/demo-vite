<template>
  <div style="height: 60px; background: lightblue;">Header</div>
  <div style="display: flex; flex-direction: row; height: calc(100vh - 120px);">
    <div>
      <tiny-tree-menu :data="treeData" menu-collapsible style="height: 100%;"></tiny-tree-menu>
    </div>
    <div>Content</div>
  </div>
  <div style="height: 60px; background: lightblue;">Footer</div>
</template>
